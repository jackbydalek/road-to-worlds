...
func _init() -> void:
	...
	var opponent_deck := _deck_entries_to_dict(archetypes_by_id["oxen"].get("starterDeck", []))
	var result: Dictionary = combat_service.auto_play_game(player_deck, "flightless_birds", opponent_deck, "oxen", 12345)
	...
	var manual_result: Dictionary = combat_service.start_manual_game(player_deck, "flightless_birds", opponent_deck, "oxen", 67890)
	...
	var target_result: Dictionary = combat_service.start_manual_game(player_deck, "flightless_birds", opponent_deck, "oxen", 24680)
	...
	var token_result: Dictionary = combat_service.start_manual_game(player_deck, "flightless_birds", opponent_deck, "oxen", 13579)
