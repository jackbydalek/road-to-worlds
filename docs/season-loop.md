...
Fresh and Funky remain available from the Debug Menu for development testing.
...
- Buy a six-card booster.
- Open earned prize packs.
- Add owned cards to the 30-card main deck. Sideboard editing is hidden in the public demo and remains available in Debug mode.
- Sell copies beyond the safe deck limit.
- Read metagame reports before choosing changes.
- Work a shop shift if the legal deck is ready but the entry fee is short.

Demo deck legality requires exactly 30 main-deck cards, legal copy counts, and enough owned copies. The retained debug sideboard supports up to six cards.
