# Pastel Tournament Day — Simplified Capsule Edit
...
Composition: bold poster-like hierarchy with only four reads at thumbnail size: title, face, booster pack, and three cards. Abundant negative space. Keep the character right-of-center and clear of the title. Maintain safe margins for a 1232×706 crop.

Style: clean original 2D pastel illustration, broad flat shapes, expressive navy outlines, limited cel shading, and subtle paper grain. Aim for a simple editorial fashion print rather than a detailed anime café scene.

Palette: cream `#FFF7F1`, steamed milk `#F5EBD8`, coral `#EF7E76`, blush `#F2A4B8`, periwinkle `#8EA9E6`, sky `#68C5E8`, muted teal `#638B83`, honey `#D8B35F`, with navy `#29365F` used only for linework and the title.

Avoid: new text, title misspelling, extra people, busy shelving, tabletop foreground, dense sparkles, repeated stickers, tiny clutter, dark background, neon, photorealism, 3D, watermark, or signature.

Generation: built-in image generation tool, precise-object-edit workflow.
